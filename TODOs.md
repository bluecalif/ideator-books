...
## Phase 4: 문서화 및 MVP 완성

**이미 완료된 작업 (Phase 1-3에서):**
- ✅ CSV 업로드 → 도서 선택 (87권 업로드 완료)
- ✅ 1p 생성 (Synthesis/Simple Merge 모두 작동)
- ✅ 히스토리 저장 및 재다운로드 (정상 작동)
- ✅ 리마인드 큐 UI (복습 카드 섹션 구현)
- ✅ 평균 생성 시간 (30-40초, 목표 달성)
...
## 수용 기준 (MVP Done)
- [x] CSV 80~90권 → 1p 생성 성공 (87권 업로드, 다수 생성 완료)
- [x] 고유문장 3개 추출 (정상 작동)
- [x] 리마인드 큐 및 복습 카드 제공 (UI 완성, 기능 작동)
- [x] 히스토리 저장 & 재다운로드 가능 (정상 작동)
- [x] 프론트엔드 6개 화면 완성
- [x] 백엔드 7개 API 엔드포인트 작동
- ⚠️ anchored_by 45-70% (목표 100%, LLM 특성상 한계)
